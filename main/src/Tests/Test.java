...
class Test {
    ...
    public void add() throws FlightPriceException, SeatTypeException, PriceException {
        ...
        Double priceExpected = 100.0 + 100.0 + 20.0;
    ...
    public void getSeatTypes() throws PriceException, AllSeatTypesException {
        Object [] seatTypesExpected = {new SeatType("Economique", 30),new SeatType("Affaire", 100), new SeatType("Premiere", 200)};
