...
CREATE TABLE `booking` (
                           ...
                           -- CONSTRAINT `flight_booking_fk` FOREIGN KEY (`flight_id`) REFERENCES `seat_booked` (`flight_id`),
                           -- CONSTRAINT `passenger_booking_fk` FOREIGN KEY (`passenger_id`) REFERENCES `passenger` (`id`),
                           -- CONSTRAINT `seat_booking_fk` FOREIGN KEY (`seat_id`) REFERENCES `seat_booked` (`seat_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

ALTER TABLE `booking`
ADD CONSTRAINT `flight_booking_fk` FOREIGN KEY (`flight_id`) REFERENCES `seat_booked` (`flight_id`);

ALTER TABLE `booking`
ADD CONSTRAINT `passenger_booking_fk` FOREIGN KEY (`passenger_id`) REFERENCES `passenger` (`id`);

ALTER TABLE `booking`
ADD CONSTRAINT `seat_booking_fk` FOREIGN KEY (`seat_id`) REFERENCES `seat_booked` (`seat_id`);
